...
Todos los elementos de la aplicacion se han hecho constraint con respecto a la pantalla para que así si se aumenta o disminuye el tamaño de la pantalla, se adapte y mantenga la posicion. Los unicos elementos de la aplicacion distintos han sido los 3 botones que he hecho que el del medio se constaint del 0 del centro y los dos botones de los lados se han hecho constraint del de en medio y a un lado de la pantalla.
